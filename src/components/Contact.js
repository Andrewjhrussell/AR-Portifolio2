...
const Contact = () => {
    return (
        <>
          ...
          Linkedin
          <a href="https://www.linkedin.com/in/andrew-russell-83679b175">
          ...
          Github
          <a href="https://github.com/Andrewjhrussell?tab=repositories">
                        <img alt="Github Logo - Free social media icons" class="n3VNCb"
                            src="https://image.flaticon.com/icons/svg/25/25231.svg"
                            style={{"width": "25px", "height": "25px", "margin": "0px;"}}/></a>
                        <div></div>
